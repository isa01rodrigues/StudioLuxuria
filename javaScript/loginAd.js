 ...
 alert('Bem-Viindo ao seu Login - Minha Agenda Web');
 function carregarLoginAdmin() {
    ...
    $("#loginForm").click(function(){
      ...
      $.ajax({
        url: '../admin/class/admin.php',        //qual caminho a url irá fazer até chegar na classe
        ...
        success: function(data){               //data nome padrão
         if(data.success)
         {
           ...
           window.location.href = 'http://localhost/luxuria/admin/index.php?p=dashboard'; // DIRECIONA PARA O DASHBOARD
         }
         else{
          //LOGIN INVÁLIDO
